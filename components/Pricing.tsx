...
export default function Pricing() {
  return (
    <div className="py-12 border-b border-brand-gray-border" id="oferta">
      ...
      <ScrollReveal direction="up" delay={200}>
        <div className="bg-brand-gray-bg border border-brand-gray-border rounded-xl p-5 mb-5">
          {valueRows.map((row, i) => (
            <div
              key={i}
      ...
      <ScrollReveal direction="up" delay={350} duration={800}>
        <div className="border-2 border-brand-red rounded-3xl overflow-hidden my-6">
          <div className="bg-brand-red px-8 py-6 text-center">
            <p className="text-[0.72rem] font-semibold tracking-[0.12em] uppercase text-white/80 mb-3">
              Curso · A Mamãe é Top e o Papai Também!
            </p>
            <p className="text-[0.85rem] text-white/60 line-through mb-0.5">De R$ 997</p>
